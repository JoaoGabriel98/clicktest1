...
class ArchivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create archive" do
    assert_difference('Archive.count') do
      post archives_url, params: { archive: { caminho: @archive.caminho, nome: @archive.nome } }
    end
  ...
  test "should update archive" do
    patch archive_url(@archive), params: { archive: { caminho: @archive.caminho, nome: @archive.nome } }
